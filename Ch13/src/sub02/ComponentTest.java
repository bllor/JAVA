...
public class ComponentTest {
	...
	private void initialize() {
		...
		btn3.setBounds(296, 45, 97, 23);
		frame.getContentPane().add(btn3);
		
		JLabel lblNewLabel_1 = new JLabel("TextField 실습");
		lblNewLabel_1.setBounds(12, 78, 97, 15);
		...
		btnName.setBounds(177, 124, 69, 23);
		...
		lbGender.setBounds(12, 417, 135, 15);
		...
		btnGender.setBounds(148, 367, 97, 23);
